...
<template>
  <div class="container mx-auto px-4 py-8">
    <!-- 封面图 -->
    <img v-if="post.metas._nv_thumbnail" :src="post.metas._nv_thumbnail" alt="封面图" class="rounded-lg w-full h-64 object-cover mb-8" />
    <div v-else class="text-center text-gray-500 h-64 bg-gray-100 rounded-lg leading-64 mb-8">暂无封面图</div>
    <!-- 文章标题 -->
